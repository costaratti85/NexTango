...
function perfiles_plegados_init() {
	...
	function placeManual(fl,an,dr,done,bi,gn,V,s){
	  var myF=(dr[bi]<0); var opts=[[false,myF],[true,!myF]], best=null;   // mx XOR my == signo del pliegue
	...
	function simulateOrder(fl,an,dr,order,V,s){
	  ...
	  for(var k=0;k<order.length;k++){
	    ...
	    // 2 orientaciones válidas: mx XOR my == signo del pliegue (la máquina siempre pliega hacia arriba)
